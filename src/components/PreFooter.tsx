  ...
  return (
    <section className="bg-white py-20 lg:py-32">
      <div className="relative grid auto-cols-fr gap-10 max-w-screen-xl px-4 mx-auto lg:grid-cols-12">
        <div className="place-self-start lg:col-span-8">
          <h2 className="mb-4 text-3xl font-normal tracking-normal md:text-4xl">
        ...
        <Button runFunc={goToContact} classNames="-rotate-90 lg:w-28 lg:h-28 w-24 h-24 lg:place-self-center"  />
      </div>
    </section>
  )
}
